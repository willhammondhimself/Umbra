...
final class MenuBarManager: NSObject {
    ...
    func setup() {
        ...
        if let button = statusItem.button {
            button.image = NSImage(systemSymbolName: "timer", accessibilityDescription: "Tether")
    ...
    func updateIcon(isInSession: Bool) {
        ...
        statusItem?.button?.image = NSImage(systemSymbolName: symbolName, accessibilityDescription: "Tether")
