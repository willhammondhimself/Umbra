...
struct IOSStatsView: View {
            ...
            VStack(spacing: 16) {
                ...
                LazyVGrid(columns: [
                    ...
                    IOSSummaryCard(
                        ...
                        icon: "percent",
                        color: Color.tetherPaused
                    )
                    IOSSummaryCard(
                        title: "Streak",
                        value: "\(periodStats.currentStreak)d",
                        icon: "flame",
                        color: Color.tetherStreak
                    )
                    IOSSummaryCard(
                        title: "Distractions",
                        value: "\(periodStats.distractionCount)",
                        icon: "exclamationmark.triangle",
                        color: Color.tetherDistracted
                    )
                }
                .padding(.horizontal)
    ...
    private func insightColor(_ type: Insight.InsightType) -> Color {
        switch type {
        case .positive: Color.tetherFocused
        case .warning: Color.tetherPaused
        case .neutral: Color.tetherNeutral
        }
    }
