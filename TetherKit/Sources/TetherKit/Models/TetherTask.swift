...
public struct TetherTask: Identifiable, Codable, Equatable, Sendable {
    public var id: Int64?
...
extension TetherTask: FetchableRecord, MutablePersistableRecord {
    ...
    public var project: QueryInterfaceRequest<Project> {
        request(for: TetherTask.project)
    }
}
