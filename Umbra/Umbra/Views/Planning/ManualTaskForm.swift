...
struct ManualTaskForm: View {
    ...
    var existingTask: UmbraTask?
    var onSave: (UmbraTask) -> Void

    @State private var title: String = ""
    @State private var estimateMinutes: Int?
    @State private var priority: UmbraTask.Priority = .medium
        ...
        VStack(spacing: 0) {
            ...
            Form {
                ...
                Picker("Priority", selection: $priority) {
                    ForEach(UmbraTask.Priority.allCases, id: \.self) { p in
    ...
    private func save() {
        var task = existingTask ?? UmbraTask(title: "")
